...
namespace CSGenio.business
{
	...
	public class CSGenioAcity : DbArea
	{
		...
		public CSGenioAcity(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL TRA CONSTRUTOR CITY]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			//- - - - - - - - - - - - - - - - - - -
			Qfield = new Field(info.Alias, "conutry_fk", FieldType.KEY_INT);
			Qfield.FieldDescription = "CONUTRY_FK";
			Qfield.FieldSize =  8;
			Qfield.MQueue = false;
			Qfield.CavDesignation = "CONUTRY_FK07117";
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ChildTable[0]= new ChildRelation("property", new String[] {"city_fk"}, DeleteProc.NA);

			// Mother Relations
			//------------------------------
			info.ParentTables = new Dictionary<string, Relation>();
			info.ParentTables.Add("country", new Relation("TRA", "tracity", "city", "codcity", "conutry_fk", "TRA", "tracountry", "country", "codcountry", "codcountry"));
		}
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.AreaPluralDesignation="city";
			info.DescriptionCav="CITY35974";
		...
		public static FieldRef FldConutry_fk { get { return m_fldConutry_fk; } }
		private static FieldRef m_fldConutry_fk = new FieldRef("city", "conutry_fk");

		/// <summary>Field : "CONUTRY_FK" Tipo: "CE" Formula:  ""</summary>
		public string ValConutry_fk
		{
			get { return (string)returnValueField(FldConutry_fk); }
			set { insertNameValueField(FldConutry_fk, value); }
		}
