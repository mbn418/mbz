...
namespace CSGenio.business
{
	...
	public class CSGenioAcountry : DbArea
	{
		...
		public CSGenioAcountry(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL TRA CONSTRUTOR COUNTRY]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ChildTable[0]= new ChildRelation("city", new String[] {"conutry_fk"}, DeleteProc.NA);
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.AreaPluralDesignation="Country";
