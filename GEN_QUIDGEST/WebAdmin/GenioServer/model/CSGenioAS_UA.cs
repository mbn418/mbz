...
namespace CSGenio.business
{
	...
	public class CSGenioAs_ua : DbArea
	{
		...
		public CSGenioAs_ua(User user, string module)
		{
            this.user = user;
            this.module = module;
			// USE /[MANUAL TRA CONSTRUTOR S_UA]/
		}
...
#pragma warning restore CS0168, S1481 // Variable is declared but never used
			...
			Qfield.Dupmsg = "";
			argumentsListByArea = new List<ByAreaArguments>();
			argumentsListByArea.Add(new ByAreaArguments(new string[] {"role"}, new int[] {0}, "s_ua", "codua"));
			Qfield.Formula = new InternalOperationFormula(argumentsListByArea, 1, delegate(object[] args, User user, string module, PersistentSupport sp) {
				return GlobalFunctions.GetLevelFromRole(0,((string)args[0]));
			});
			info.RegisterFieldDB(Qfield);
		...
		private static void InicializaRelacoes(AreaInfo info)
		{
			...
			info.ParentTables.Add("psw", new Relation("TRA", "userauthorization", "s_ua", "codua", "codpsw", "TRA", "userlogin", "psw", "codpsw", "codpsw"));
		}
		...
		/// <summary>Field : "Level" Tipo: "N" Formula: + "GetLevelFromRole(0, [S_UA->ROLE])"</summary>
