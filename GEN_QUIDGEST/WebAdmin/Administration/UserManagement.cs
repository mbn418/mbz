...
namespace Administration
{
    ...
    public class UserManagement : IUserManagementService
    {
        ...
        public List<ModulesLevel> GetPermissions()
        {
            ...
            perm.Add(new ModulesLevel("TRA", Resources.Resources.MY_APPLICATION56216, "1", Resources.Resources.CONSULTA40695));
            perm.Add(new ModulesLevel("TRA", Resources.Resources.MY_APPLICATION56216, "5", Resources.Resources.OFFICER63190));
            perm.Add(new ModulesLevel("TRA", Resources.Resources.MY_APPLICATION56216, "12", Resources.Resources.BROKER37082));
            perm.Add(new ModulesLevel("TRA", Resources.Resources.MY_APPLICATION56216, "99", Resources.Resources.ADMINISTRADOR57294));
        ...
        public bool CreateUserWithPassAndLevels(string username, string password, List<ModulesLevel> levels)
        {
            ...
            try
            {
                ...
                CSGenioApsw userPsw = new CSGenioApsw(user, "TRA");
