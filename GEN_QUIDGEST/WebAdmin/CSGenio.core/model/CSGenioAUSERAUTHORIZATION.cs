...
namespace CSGenio.business
{
	...
	public class CSGenioAuserauthorization : DbArea
	{
		...
		private static AreaInfo InicializaAreaInfo()
		{
			...
			info.ParentTables.Add("psw", new Relation("TRA", "userauthorization", "userauthorization", "codua", "codpsw", "TRA", "userlogin", "psw", "codpsw", "codpsw"));
		...
		// USE /[MANUAL TRA TABAUX UserAuthorization]/
