...
namespace CSGenio.framework
{
    ...
    public static class Configuration
    {
        ...
        /// System id
        /// </summary>
        public static string Program { get; } = "TRA";
        ...
        /// Modules
        /// </summary>
        public static readonly List<string> Modules = ["TRA"];
        ...
        /// Login Type
        /// </summary>
        public static LoginTypes LoginType { get; private set; } = LoginTypes.MANUAL;
        ...
        {
			// USE /[MANUAL TRA RESOLVEDATASYSTEM]/
            DataSystemXml ds;
            switch (db)
            {
