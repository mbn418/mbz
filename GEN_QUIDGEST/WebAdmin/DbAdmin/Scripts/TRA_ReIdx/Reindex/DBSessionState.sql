...
https://github.com/microsoft/sql-server-samples/tree/master/samples/applications/aspnet-session-state
...
SET @SQL = N'
CREATE DATABASE [ASPStateTRA]
 CONTAINMENT = NONE
 ON  PRIMARY 
	(NAME = N''ASPStateTRA'', FILENAME = N''' + @SQLDataFolder + 'ASPStateTRA.mdf'' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB ), 
 FILEGROUP [ASPStateTRA_mod] CONTAINS MEMORY_OPTIMIZED_DATA  DEFAULT
	(NAME = N''ASPStateTRA_mod'', FILENAME = N''' + @SQLLogFolder + 'ASPStateTRA_mod'' , MAXSIZE = UNLIMITED)
 LOG ON 
	(NAME = N''ASPStateTRA_log'', FILENAME = N''' + @SQLLogFolder + 'ASPStateTRA_log.ldf'' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB );

ALTER DATABASE [ASPStateTRA] SET COMPATIBILITY_LEVEL = 130; ALTER DATABASE [ASPStateTRA] SET MEMORY_OPTIMIZED_ELEVATE_TO_SNAPSHOT=ON;'
