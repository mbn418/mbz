    ...
    public class PersistentSupportSQLServer : PersistentSupport
    {
        ...
        public override void transferMSMQLog(bool all)
        {
            ...
            if (!all && Configuration.MaxLogRowDays > 0)
            {
                ...
                filterMQQueues.LesserOrEqual("TRAMQQueues_History", "DATASTATUS", lastDate);
            }
                ...
                using (System.Data.SqlClient.SqlTransaction logTransaction = (System.Data.SqlClient.SqlTransaction)this.Connection.BeginTransaction())
                {
                    try
                    {
                        ...
                        SelectQuery query = new SelectQuery()
                            .Select("TRAMQQueues_History", "CODMQQUEUES", "CODMQQUEUES")
                            .Select("TRAMQQueues_History", "QUEUEID", "QUEUEID")
							.Select("TRAMQQueues_History", "CHANNELID", "CHANNELID")
                            .Select("TRAMQQueues_History", "ANO", "ANO")
                            .Select("TRAMQQueues_History", "USERNAME", "USERNAME")
                            .Select("TRAMQQueues_History", "TABELA", "TABELA")
                            .Select("TRAMQQueues_History", "TABELACOD", "TABELACOD")
                            .Select("TRAMQQueues_History", "QUEUEKEY", "QUEUEKEY")
                            .Select("TRAMQQueues_History", "QUEUE", "QUEUE")
                            .Select("TRAMQQueues_History", "MQSTATUS", "MQSTATUS")
                            .Select("TRAMQQueues_History", "DATASTATUS", "DATASTATUS")
                            .Select("TRAMQQueues_History", "DATACRIA", "DATACRIA")
                            .Select("TRAMQQueues_History", "OPERACAO", "OPERACAO")
                            .Select("TRAMQQueues_History", "RESPOSTA", "RESPOSTA")
                            .Select("TRAMQQueues_History", "SENDNUMBER", "SENDNUMBER")
                            .Select("TRAMQQueues_History", "ZZSTATE", "ZZSTATE")
                            .From("TRAMQQueues_History")
                            .Where(filterMQQueues)
                            .OrderBy("TRAMQQueues_History", "DATACRIA", Quidgest.Persistence.GenericQuery.SortOrder.Ascending);
                        ...
                        using (IDataReader dr = command.ExecuteReader())
                        {
                            ...
                            using (System.Data.SqlClient.SqlBulkCopy bulkCopy = new System.Data.SqlClient.SqlBulkCopy(
                                ...
                                logTransaction))
                            {
                                bulkCopy.DestinationTableName = "dbo.TRAMQQueues_History";
