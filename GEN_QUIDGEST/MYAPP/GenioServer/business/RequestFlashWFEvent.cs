...
{
    public class RequestFlashWFEvent
    {
        ...
        /// <summary>
        /// Constructor da classe RequestFlashWFEvent
        /// </summary>
        /// <param name="nomeComando"></param>
        /// <param name="parametro"></param>
        /// <param name="campos"></param>
        /// <param name="tipoFlash"></param>
        public RequestFlashWFEvent(string id, string tipoId, string codigo, string name, string duracao, string codservico, string servico,
		...
		public string toXML()
        {
            // Use /[MANUAL TRA GW_EVENT_TOXML]/ to override this
			// USE /[MANUAL TRA GW_EVENT_TOXML]/
			return "";
		}
    }
}
