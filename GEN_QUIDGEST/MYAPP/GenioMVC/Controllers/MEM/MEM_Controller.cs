...
// USE /[MANUAL TRA INCLUDE_CONTROLLER MEM]/

namespace GenioMVC.Controllers
{
	public partial class MemController : ControllerBase
	{
		private IChatbotService _aiService;
		public MemController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION MEM]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAmem>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TRA MANUAL_CONTROLLER MEM]/
		...
		{
			return base.GetDocumsTickets("MEM", requestModel.FieldName, requestModel.KeyValue);
		}
