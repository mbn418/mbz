...
// USE /[MANUAL TRA INCLUDE_CONTROLLER S_ARG]/
...
namespace GenioMVC.Controllers
{
	public partial class S_argController : ControllerBase
	{
		...
		public S_argController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION S_ARG]/
...
// USE /[MANUAL TRA MANUAL_CONTROLLER S_ARG]/
		...
		{
			return base.GetDocumsTickets("S_ARG", requestModel.FieldName, requestModel.KeyValue);
		}
