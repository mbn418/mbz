...
// USE /[MANUAL TRA INCLUDE_CONTROLLER S_APR]/
...
namespace GenioMVC.Controllers
{
	public partial class S_aprController : ControllerBase
	{
		...
		public S_aprController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION S_APR]/
...
// USE /[MANUAL TRA MANUAL_CONTROLLER S_APR]/
		...
		{
			return base.GetDocumsTickets("S_APR", requestModel.FieldName, requestModel.KeyValue);
		}
