...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_TRA_MENU_411 = new NavigationLocation("COUNTRY64133", "TRA_Menu_411", "Country") { vueRouteName = "menu-TRA_411" };


		//
		// GET: /Country/TRA_Menu_411
