...
namespace GenioMVC.Controllers
{
	public partial class CountryController : ControllerBase
	{
		...
		public CountryController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION COUNTRY]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAcountry>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TRA MANUAL_CONTROLLER COUNTRY]/
		...
		/// <summary>
		/// Recalculate formulas of the "Country" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_Country([FromBody]Country_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "country",
				(primaryKey) => Models.Country.Find(primaryKey, UserContext.Current, "FCOUNTRY"),
		...
		{
			return base.GetDocumsTickets("COUNTRY", requestModel.FieldName, requestModel.KeyValue);
		}
