...
// USE /[MANUAL TRA INCLUDE_CONTROLLER S_UA]/

namespace GenioMVC.Controllers
{
	public partial class S_uaController : ControllerBase
	{
		private IChatbotService _aiService;
		public S_uaController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION S_UA]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAs_ua>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TRA MANUAL_CONTROLLER S_UA]/
		...
		{
			return base.GetDocumsTickets("S_UA", requestModel.FieldName, requestModel.KeyValue);
		}
