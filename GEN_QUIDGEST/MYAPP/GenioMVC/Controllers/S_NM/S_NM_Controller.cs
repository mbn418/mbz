...
// USE /[MANUAL TRA INCLUDE_CONTROLLER S_NM]/

namespace GenioMVC.Controllers
{
	public partial class S_nmController : ControllerBase
	{
		private IChatbotService _aiService;
		public S_nmController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION S_NM]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAs_nm>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TRA MANUAL_CONTROLLER S_NM]/
		...
		{
			return base.GetDocumsTickets("S_NM", requestModel.FieldName, requestModel.KeyValue);
		}
