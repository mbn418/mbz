...
namespace GenioMVC.Controllers
{
	...
	{
		private static readonly NavigationLocation ACTION_TRA_MENU_41 = new NavigationLocation("CONTACT05134", "TRA_Menu_41", "Contact") { vueRouteName = "menu-TRA_41" };


		//
		// GET: /Contact/TRA_Menu_41
