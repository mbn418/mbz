...
// USE /[MANUAL TRA INCLUDE_CONTROLLER S_NES]/

namespace GenioMVC.Controllers
{
	public partial class S_nesController : ControllerBase
	{
		private IChatbotService _aiService;
		public S_nesController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION S_NES]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAs_nes>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TRA MANUAL_CONTROLLER S_NES]/
		...
		{
			return base.GetDocumsTickets("S_NES", requestModel.FieldName, requestModel.KeyValue);
		}
