...
namespace GenioMVC.Controllers
{
	public partial class PropertyController : ControllerBase
	{
		...
		public ActionResult TRA_Menu_21([FromBody] RequestMenuModel requestModel)
		{
			...
			CSGenio.core.framework.table.legacy.v1.TableConfigurationUpdate.SetFilterShiftValue(model.Uuid, "filter_TRA_Menu_21_BULDINGTYP", -1);
...
// USE /[MANUAL TRA OVERRQEXPORT 411]/
		...
		public ActionResult TRA_Menu_511([FromBody] RequestMenuModel requestModel)
		{
			...
			Navigation.SetValue("property.sold", "1");
