...
namespace GenioMVC.Controllers
{
	public partial class PropertyController : ControllerBase
	{
		...
		public PropertyController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION PROPERTY]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAproperty>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TRA MANUAL_CONTROLLER PROPERTY]/
		...
		public JsonResult ReloadDBEdit([FromBody]RequestReloadDBEditModel requestModel)
		{
			...
			*/
			Models.Property row = new Models.Property(UserContext.Current, isEmpty: true);
			row.klass.QPrimaryKey = Navigation.GetStrValue("property");
					...
					case "F_PROPERTY__BROKER__NAME":	// Field (DB)
						{
							...
							model.Load_F_property__broker__name(qs);
							result = model.TableBrokerName;
						}
						break;
					default:
						break;
		...
		/// <summary>
		/// Recalculate formulas of the "F_property" form. (++, CT, SR, CL and U1)
		/// </summary>
		/// <param name="formData">Current form data</param>
		/// <returns></returns>
		[HttpPost]
		public JsonResult RecalculateFormulas_F_property([FromBody]F_property_ViewModel formData)
		{
			return GenericRecalculateFormulas(formData, "property",
				(primaryKey) => Models.Property.Find(primaryKey, UserContext.Current, "FF_PROPERTY"),
				(model) => formData.MapToModel(model as Models.Property)
			);
		}
		...
		{
			return base.GetDocumsTickets("PROPERTY", requestModel.FieldName, requestModel.KeyValue);
		}
