...
namespace GenioMVC.Controllers
{
	public partial class BrokerController : ControllerBase
	{
		...
		public BrokerController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION BROKER]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAbroker>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
...
// USE /[MANUAL TRA MANUAL_CONTROLLER BROKER]/
		...
		{
			return base.GetDocumsTickets("BROKER", requestModel.FieldName, requestModel.KeyValue);
		}
