...
// USE /[MANUAL TRA INCLUDE_CONTROLLER S_PAX]/

namespace GenioMVC.Controllers
{
	public partial class S_paxController : ControllerBase
	{
		private IChatbotService _aiService;
		public S_paxController(UserContextService userContext, IChatbotService aiService) : base(userContext)
		{
			_aiService = aiService;
		}

// USE /[MANUAL TRA CONTROLLER_NAVIGATION S_PAX]/



		private List<string> GetActionIds(CriteriaSet crs, CSGenio.persistence.PersistentSupport sp = null)
		{
			CSGenio.business.Area area = CSGenio.business.Area.createArea<CSGenioAs_pax>(UserContext.Current.User, UserContext.Current.User.CurrentModule);
			return base.GetActionIds(crs, sp, area);
		}

// USE /[MANUAL TRA MANUAL_CONTROLLER S_PAX]/
		...
		{
			return base.GetDocumsTickets("S_PAX", requestModel.FieldName, requestModel.KeyValue);
		}
