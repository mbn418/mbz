...
namespace GenioMVC.ViewModels.City
{
	public class TRA_Menu_31_ViewModel : MenuListViewModel<Models.City>
	{
		...
		public TablePartial<TRA_Menu_31_RowViewModel> Menu { get; set; }
...
// USE /[MANUAL TRA LIST_LIMITS 31]/
		...
		public TRA_Menu_31_ViewModel() : base(null!) { }

		/// <summary>
		/// Initializes a new instance of the <see cref="TRA_Menu_31_ViewModel" /> class.
		/// </summary>
		/// <param name="userContext">The current user request context</param>
		public TRA_Menu_31_ViewModel(UserContext userContext) : base(userContext)
		{
		...
		public TRA_Menu_31_ViewModel(UserContext userContext, Models.ModelBase parentCtx) : this(userContext)
		{
			ParentCtx = parentCtx;
		}
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAcity> Qlisting, ref CriteriaSet conditions)
		{
			...
			CriteriaSet tra_menu_31Conds = CriteriaSet.And();
			...
			conditions.SubSets.Add(tra_menu_31Conds);
			tra_menu_31Conds = BuildCriteriaSet(tableConfig, requestValues, out bool hasAllRequiredLimits, conditions, isToExport);
			tableReload &= hasAllRequiredLimits;

// USE /[MANUAL TRA OVERRQ 31]/
...
// USE /[MANUAL TRA OVERRQLIST 31]/
				...
				Menu.Elements = MapTRA_Menu_31(listing);
			...
			if (Qlisting.Rows != null)
			{
				foreach (var row in Qlisting.Rows)
				{
					if (Qlisting.NumRegs > 0 && i >= Qlisting.NumRegs) // Copiado da versão antiga do RowsToViewModels
						break;
					Elements.Add(MapTRA_Menu_31(row));
					i++;
				}
			}
...
// USE /[MANUAL TRA VIEWMODEL_CUSTOM TRA_MENU_31]/
