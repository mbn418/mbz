...
{
	public class TRA_Menu_411_ViewModel : MenuListViewModel<Models.Country>
	{
		/// <summary>
		...
		public override string Uuid => "10e4d60d-607c-46a3-a641-1824513cf703";
...
// USE /[MANUAL TRA LIST_LIMITS 411]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Country.AddEPH<CSGenioAcountry>(ref u, crs, "ML411");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Country.AddEPH<CSGenioAcountry>(ref u, null, "ML411"));
			}
...
// USE /[MANUAL TRA OVERRQ 411]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAcountry>(m_userContext, false, ref tra_menu_411Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML411", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRA OVERRQLIST 411]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAcountry.GetInformation(), QMVC_POS_RECORD, sorts, tra_menu_411Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAcountry> listing = Models.ModelBase.Where<CSGenioAcountry>(m_userContext, distinct, tra_menu_411Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML411", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<TRA_Menu_411_RowViewModel> MapTRA_Menu_411(ListingMVC<CSGenioAcountry> Qlisting)
		{
		...
		private TRA_Menu_411_RowViewModel MapTRA_Menu_411(CSGenioAcountry row)
		{
