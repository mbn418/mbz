...
namespace GenioMVC.ViewModels.Broker
{
	public class F_broker_ViewModel : FormViewModel<Models.Broker>, IPreparableForSerialization
	{
		...
		/// </summary>
		public DateTime? ValBrithdate { get; set; }
		/// <summary>
		/// Title: "Email" | Type: "C"
		/// </summary>
		...
		public override void MapFromModel(Models.Broker m)
		{
			...
			try
			{
				...
				ValBrithdate = ViewModelConversion.ToDateTime(m.ValBrithdate);
		...
		public override void MapToModel(Models.Broker m)
		{
			...
			try
			{
				...
				m.ValBrithdate = ViewModelConversion.ToDateTime(ValBrithdate);
			...
			try
			{
				...
				switch (fullFieldName)
				{
					...
					case "broker.name":
						...
						break;
					case "broker.brithdate":
						this.ValBrithdate = ViewModelConversion.ToDateTime(_value);
						break;
					case "broker.email":
...
// USE /[MANUAL TRA VIEWMODEL_NEW F_BROKER]/
		...
		public override CrudViewModelValidationResult Validate()
		{
			...
			validator.StringLength("ValEmail", Resources.Resources.EMAIL25170, ValEmail, 250);
...
// USE /[MANUAL TRA VIEWMODEL_DESTROY F_BROKER]/
		...
		protected override object GetViewModelValue(string identifier, object modelValue)
		{
			return identifier switch
			{
				...
				"broker.brithdate" => ViewModelConversion.ToDateTime(modelValue),
		...
		{
			if (ValPhoto != null)
				ValPhoto.Ticket = Helpers.Helpers.GetFileTicket(m_userContext.User, CSGenio.business.Area.AreaBROKER, CSGenioAbroker.FldPhoto.Field, null, ValCodbroker);
		}
