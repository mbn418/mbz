...
{
	public class TRA_Menu_61_ViewModel : MenuListViewModel<Models.Broker>
	{
		/// <summary>
...
// USE /[MANUAL TRA LIST_LIMITS 61]/
		...
		public override CriteriaSet BuildCriteriaSet(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, out bool tableReload, CriteriaSet crs = null, bool isToExport = false)
		{
			...
			{
				// EPH
				crs = Models.Broker.AddEPH<CSGenioAbroker>(ref u, crs, "ML61");
			...
			if (tableReload)
			{
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
					crs.Equals(Models.Broker.AddEPH<CSGenioAbroker>(ref u, null, "ML61"));
			}
...
// USE /[MANUAL TRA OVERRQ 61]/
			...
			if (isToExport)
			{
				...
				Qlisting = Models.ModelBase.BuildListingForExport<CSGenioAbroker>(m_userContext, false, ref tra_menu_61Conds, exportFieldRefs, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61", true, firstVisibleColumn: firstVisibleColumn);
...
// USE /[MANUAL TRA OVERRQLIST 61]/
				...
				if (!string.IsNullOrEmpty(QMVC_POS_RECORD))
				{
					var m_iCurPag = m_userContext.PersistentSupport.getPagingPos(CSGenioAbroker.GetInformation(), QMVC_POS_RECORD, sorts, tra_menu_61Conds, m_PagingPosEPHs, firstVisibleColumn: firstVisibleColumn);
					if (m_iCurPag != -1)
						pageNumber = ((m_iCurPag - 1) / numberListItems) + 1;
				}

				ListingMVC<CSGenioAbroker> listing = Models.ModelBase.Where<CSGenioAbroker>(m_userContext, distinct, tra_menu_61Conds, fields, (pageNumber - 1) * numberListItems, numberListItems, sorts, "ML61", true, false, QMVC_POS_RECORD, m_PagingPosEPHs, firstVisibleColumn, fieldsWithTotalizers, tableConfig.SelectedRows);
		...
		private List<TRA_Menu_61_RowViewModel> MapTRA_Menu_61(ListingMVC<CSGenioAbroker> Qlisting)
		{
		...
		private TRA_Menu_61_RowViewModel MapTRA_Menu_61(CSGenioAbroker row)
		{
