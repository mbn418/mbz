...
namespace GenioMVC.ViewModels.Broker
{
	public class TRA_Menu_11_ViewModel : MenuListViewModel<Models.Broker>
	{
		...
		public override string Uuid => "53da6052-cd9a-475e-bb7c-e2638e32a408";
...
// USE /[MANUAL TRA LIST_LIMITS 11]/
		...
		public override int GetCount(User user)
		{
			...
			FieldRef[] fields = new FieldRef[] { CSGenioAbroker.FldCodbroker, CSGenioAbroker.FldZzstate, CSGenioAbroker.FldPhoto, CSGenioAbroker.FldBrithdate, CSGenioAbroker.FldName, CSGenioAbroker.FldEmail };
		...
		public void Load(CSGenio.core.framework.table.TableConfiguration tableConfig, NameValueCollection requestValues, bool ajaxRequest, bool isToExport, ref ListingMVC<CSGenioAbroker> Qlisting, ref CriteriaSet conditions)
		{
			...
			allSortOrders.Add("BROKER.BRITHDATE", new OrderedDictionary());
			allSortOrders["BROKER.BRITHDATE"].Add("BROKER.BRITHDATE", "A");
			...
			if (sorts == null || sorts.Count == 0)
			{
				...
				sorts.Add(new ColumnSort(new ColumnReference(CSGenioAbroker.FldBrithdate), SortOrder.Ascending));
...
// USE /[MANUAL TRA VIEWMODEL_CUSTOM TRA_MENU_11]/
		...
		[
			"Broker", "Broker.ValCodbroker", "Broker.ValZzstate", "Broker.ValPhoto", "Broker.ValBrithdate", "Broker.ValName", "Broker.ValEmail"
		];

		private static readonly List<TableSearchColumn> _searchableColumns =
		[
			new TableSearchColumn("ValBrithdate", CSGenioAbroker.FldBrithdate, typeof(DateTime?)),
			new TableSearchColumn("ValName", CSGenioAbroker.FldName, typeof(string)),
