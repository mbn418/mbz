<template>
	<teleport
		v-if="isReady"
		to="#q-modal-see-more-photo-property-title-body">
		<q-row>
			<q-table
				v-bind="listCtrl"
...
<script>
	...
	const requiredTextResources = ['PHOTO__PROPERTY__TITLE_SeeMore', 'hardcoded', 'messages']

	export default {
		name: 'PhotoPropertyTitleSeeMore',
		...
		data()
		{
			return {
				...
				componentOnLoadProc: asyncProcM.getProcListMonitor('PHOTO__PROPERTY__TITLE_SeeMore', false),

				interfaceMetadata: {
					id: 'PHOTO__PROPERTY__TITLE_SeeMore', // Used for resources
					requiredTextResources
				},

				menuInfo: {
					acronym: 'PHOTO__PROPERTY__TITLE_SeeMore',
					name: 'PHOTO__PROPERTY__TITLE_SeeMore',
					controller: 'PHOTO_ALBUM',
					action: 'PHOTO_PropertyValTitle'
				},
		...
		mounted()
		{
			...
			const modalProps = {
				id: 'see-more-photo-property-title',
				dismissAction: this.close,
				returnElement: 'PHOTO__PROPERTY__TITLE_see-more_button'
			}
			const props = {
		...
		beforeUnmount()
		{
			...
			removeModal('see-more-photo-property-title')
		},
			...
			getListConfig()
			{
				...
				const listProps = {
					configuration: {
						...
						uuid: 'Photo_Photo_PropertyValTitle',
